...
export default function EditListing() {
  ...
  //in fetching id from firestore(DB) we use params from react-R-D
  const params = useParams();

  //set a check rule for the userRef
  useEffect(() => {
    if (listing && listing.userRef !== auth.currentUser.uid) {
      toast.error("You can't edit this page");
      navigate("/");
    }
  }, [auth.currentUser.uid, listing, navigate]);

  //fetch and populate the listing data according to the Id
  useEffect(() => {
    setLoading(true);
  ...
  async function onSubmit(e) {
    ...
    //add and update to db
    const docRef = doc(db, "listings", params.listingId);
    await updateDoc(docRef, formDataCopy);
    setLoading(false);
    toast.success("House listing Edited");
  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit} className=" bg-orange-50 p-6 shadow-lg">
        ...
        <input
          ...
          minLength="10"
          required
          className="w-full px-4 py-2 text-xl text-red-700 bg-white border border-gray-400 rounded transition duration-150 ease-in-out
        ...
        <p className="text-lg mt-6 font-semi">Parking spot</p>
        <div className="flex">
          <button
            type="button"
            id="parking"
        ...
        <p className="text-lg mt-6 font-semi">Furnished</p>
        <div className="flex ">
          <button
            type="button"
            id="furnished"
        ...
        <p className="text-lg  font-semi">Offer</p>
