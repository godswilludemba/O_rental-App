          ...
          <form>
            ...
            <input
              ...
              className={`w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition ease-in-out mb-6 ${
                changeDetail && "bg-orange-200 focus:bg-inherit"
              }`}
            />
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6">
              <p className="flex items-center ">
                ...
                <span
                  ...
                  className="text-red-600 hover:text-red-700 transition ease-in-out duration-200 m-1 cursor-pointer"
                >
              ...
              <p
                onClick={onLogout}
                className="text-blue-600 hover:text-blue-900 transition duration-200 ease-in-out cursor-pointer"
              >
                Sign Out
              </p>
            </div>
